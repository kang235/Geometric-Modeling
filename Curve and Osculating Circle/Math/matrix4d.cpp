...
const Matrix4d Matrix4d::operator+(const Matrix4d & rhs) const		//overloaded operators
{
...
const Matrix4d Matrix4d::operator*(const Matrix4d & rhs) const
{
	...
	//Optimize for when bottom row of 1st matrix is (0, 0, 0, 1)
	if(	m[3]==0.0f && m[7]==0.0f && m[11]==0.0f && m[15]==1.0f)
	{
...
const Matrix4d Matrix4d::operator*(const float rhs) const
{
...
const Matrix4d operator*(float scaleFactor, const Matrix4d & rhs)
{
	return rhs*scaleFactor;
}

const bool Matrix4d::operator==(const Matrix4d & rhs) const
{
	for(int i=0;i<16;i++)
	{
...
const void Matrix4d::operator+=(const Matrix4d & rhs)
{
	(*this)=(*this)+rhs;
}
...
const void Matrix4d::operator*=(const float rhs)
{
	(*this)=(*this)*rhs;
}
...
const Matrix4d Matrix4d::operator-(void) const
{
...
const Vect4d Matrix4d::operator*(const Vect4d rhs) const
{
