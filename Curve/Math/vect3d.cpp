...
const Vect3d operator*(float scaleFactor, const Vect3d & rhs)
{
	return rhs*scaleFactor;
}

const bool Vect3d::operator==(const Vect3d & rhs) const
{
...
//input are the two vectors ab and ac from a triangle
float Vect3d::AreaOfATriangle(Vect3d &ac)
{
	float ret=0;
	ret=0.5f*this->Cross(ac).Length();
	return ret;
}