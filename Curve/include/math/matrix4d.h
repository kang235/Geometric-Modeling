...
public:
	...
	//binary operators
	const Matrix4d operator+(const Matrix4d & rhs) const;
	const Matrix4d operator-(const Matrix4d & rhs) const;
	const Matrix4d operator*(const Matrix4d & rhs) const;
	const Matrix4d operator*(const float rhs) const;
	const Matrix4d operator/(const float rhs) const;
	const friend Matrix4d operator*(float scaleFactor, const Matrix4d & rhs);

	const bool operator==(const Matrix4d & rhs) const;
	const bool operator!=(const Matrix4d & rhs) const;

	//self-add etc
	const void operator+=(const Matrix4d & rhs);
	const void operator-=(const Matrix4d & rhs);
	const void operator*=(const Matrix4d & rhs);
	...
	const Matrix4d operator+(void) const {return (*this);}
